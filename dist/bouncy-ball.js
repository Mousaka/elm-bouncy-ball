...
var _user$project$Model$windowSize = _elm_lang$window$Window$size;
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {x: a, y: b, velocity: c, direction: d, window: e, windowDelta: f};
	});
var _user$project$Model$TimeUpdate = function (a) {
	return {ctor: 'TimeUpdate', _0: a};
};
var _user$project$Model$FetchErrors = function (a) {
	return {ctor: 'FetchErrors', _0: a};
};
var _user$project$Model$Resize = function (a) {
	return {ctor: 'Resize', _0: a};
};
var _user$project$Model$windowSizeCmd = A2(_elm_lang$core$Task$perform, _user$project$Model$Resize, _user$project$Model$windowSize);
var _user$project$Model$init = {
	...
	_1: _user$project$Model$windowSizeCmd
};

var _user$project$Update$applyGravity = F2(
	function (dt, model) {
		var v_ = model.velocity + 0.1;
		var newY = model.y + (v_ * dt);
		return _elm_lang$core$Native_Utils.update(
			model,
			{y: newY, velocity: v_});
	});
var _user$project$Update$bounce = F2(
	function (dt, model) {
		var bottomSpeed = _elm_lang$core$Basics$toFloat(model.windowDelta.height) * 0.2;
		var y_ = (_elm_lang$core$Native_Utils.cmp(model.velocity, 0.2) < 0) ? _elm_lang$core$Basics$toFloat(model.window.height - 200) : _elm_lang$core$Basics$toFloat((model.window.height - 200) - 1);
		return _elm_lang$core$Native_Utils.update(
			model,
			{y: y_, velocity: bottomSpeed + (model.velocity * -0.7)});
	});
var _user$project$Update$windDrag = F2(
	function (dt, model) {
		var drag = (model.velocity * dt) * 5.0e-4;
		return _elm_lang$core$Native_Utils.update(
			model,
			{velocity: model.velocity - drag});
	});
var _user$project$Update$hitBottom = F2(
	function (dt, model) {
		var height = _elm_lang$core$Basics$toFloat(model.window.height - 200);
		var _p0 = _elm_lang$core$Native_Utils.cmp(model.y, height) > -1;
		if (_p0 === true) {
			return A2(_user$project$Update$bounce, dt, model);
		} else {
			return model;
		}
	});
var _user$project$Update$resetWindowDt = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			windowDelta: {width: 0, height: 0}
...
var _user$project$Update$physics = F2(
	function (dt, model) {
		return _user$project$Update$resetWindowDt(
			A2(
				_user$project$Update$applyGravity,
				dt,
				A2(
					_user$project$Update$windDrag,
					dt,
					A2(_user$project$Update$hitBottom, dt, model))));
	});
var _user$project$Update$resize = F2(
	function (model, size) {
		var sizeDt = {width: size.width - model.window.width, height: size.height - model.window.height};
		return _elm_lang$core$Native_Utils.update(
			model,
			{window: size, windowDelta: sizeDt});
	});
var _user$project$Update$updateHelp = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'Resize':
				return A2(_user$project$Update$resize, model, _p1._0);
			case 'TimeUpdate':
				return A2(_user$project$Update$physics, _p1._0, model);
			default:
				return model;
		}
	});
...
var _user$project$View$status = function (model) {
	return A2(
		...
		A2(
			...
			_elm_lang$html$Html$text,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Basics$toString(model.window),
					_1: {
						ctor: '::',
						_0: ' Y ',
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$round(model.y)),
							_1: {
								ctor: '::',
								_0: ' X ',
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Basics$toString(
										_elm_lang$core$Basics$round(model.x)),
									_1: {
										ctor: '::',
										_0: ' velocity ',
										_1: {
											ctor: '::',
											_0: _elm_lang$core$Basics$toString(
												_elm_lang$core$Basics$round(model.velocity)),
											_1: {
												ctor: '::',
												_0: ' deltaWindow ',
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Basics$toString(model.windowDelta.height),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$View$ballPos = F2(
	function (x, y) {
		return _user$project$View$styles(
			{
				ctor: '::',
...
var _user$project$View$ball = F2(
	function (pos, size) {
		var ballRad = 100;
		var ballWidth = A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(ballRad * 2),
			'px');
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: A2(_user$project$View$ballPos, pos.x, pos.y),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$svg$Svg$svg,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$width(ballWidth),
							_1: {ctor: '[]'}
						}
					},
					{
...
var _user$project$View$view = function (model) {
	return A2(
					...
					_1: {
						...
						_1: {
							...
							_0: _rtfeldman$elm_css$Css$backgroundColor(
								_rtfeldman$elm_css$Css$hex('#F0FFFF')),
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$fontSize(_rtfeldman$elm_css$Css$larger),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		{
			ctor: '::',
			_0: _user$project$View$status(model),
			_1: {
				ctor: '::',
				_0: A2(_user$project$View$ball, model, model.window),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Model$TimeUpdate),
			_1: {
				ctor: '::',
				_0: _elm_lang$window$Window$resizes(_user$project$Model$Resize),
				_1: {ctor: '[]'}
			}
		});
};
